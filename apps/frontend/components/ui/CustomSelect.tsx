  ...
  return (
    ...
    >
      <button
        ...
        className="flex items-center justify-between gap-2 rounded-2xl bg-[--color-background] px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 focus:outline-none cursor-pointer"
      >
