        ...
        <div className="bg-white rounded-3xl p-6 shadow-xl border border-gray-100 sticky top-24">
          ...
          <div className="mt-8 space-y-3">
            ...
            {adSlot.publisher?.isVerified && (
              <div className="flex items-start gap-3 text-sm font-medium text-[--text-primary]">
                <svg className="w-5 h-5 text-[--text-primary] shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
